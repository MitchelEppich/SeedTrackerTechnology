        ...
        <div className="w-full h-20 bg-yellow pin-t flex flex-wrap items-center shadow-md fixed z-50">
            ...
            <div className="inline-flex justify-end w-2/3 pr-8 pin-r sm:hidden xs:hidden">
                <ul className="inline-flex justify-end">
                    <a href="#"><li className="menu-item p-4 xs:p-2 sm:p-2 ml-2 text-navy-blue hover:bg-navy-blue hover:text-white font-bold uppercase cursor-pointer">Home</li></a>
                    <a href="#about"><li className="menu-item p-4 xs:p-2 sm:p-2 ml-2 text-navy-blue hover:bg-navy-blue hover:text-white font-bold uppercase cursor-pointer">About</li></a>
                    <a href="#"><li className="menu-item p-4 xs:p-2 sm:p-2 ml-2 text-navy-blue hover:bg-navy-blue hover:text-white font-bold uppercase cursor-pointer">How To Use</li></a>
                    <a href="#stt"><li className="menu-item p-4 xs:p-2 sm:p-2 ml-2 text-navy-blue hover:bg-navy-blue hover:text-white font-bold uppercase cursor-pointer">STT</li></a>
                </ul>   
            </div> 
            ...
            <div className="absolute pin-t mt-20 bg-navy-blue xxl:hidden xl:hidden lg:hidden md:hidden w-full">
