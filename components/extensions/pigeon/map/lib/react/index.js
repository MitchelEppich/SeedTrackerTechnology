...
function wikimedia(x, y, z) {
  ...
  return 'http://services.arcgisonline.com/ArcGIS/rest/services/Canvas/World_Dark_Gray_Base/MapServer/tile/' + z + '/' + y + '/' + x + (retina ? '@2x' : '') + '.png';
}
  ...
  _createClass(Map, [{
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: {
        ...
        }, className: boxClassname }, _infact.React.createElement('div', { style: {
          position: 'absolute',
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { key: 'attr', className: 'pigeon-attribution', style: {
          ...
          color: '#333'
        } }, attributionPrefix === false ? null : _infact.React.createElement('span', null, attributionPrefix || _infact.React.createElement('a', { href: 'https://pigeon-maps.js.org/', style: linkStyle }, 'Pigeon'), ' | '), attribution || _infact.React.createElement('span', null, ' © ', _infact.React.createElement('a', { href: 'https://www.openstreetmap.org/copyright', style: linkStyle }, 'OpenStreetMap'), ' contributors'));
    }
  }, {
    key: 'renderWarning',
    value: function () {
    ...
    value: function () {
      ...
      return _infact.React.createElement('div', { style: containerStyle, ref: this.setRef, onWheel: this.handleWheel }, hasSize && this.renderTiles(), hasSize && this.renderOverlays(), hasSize && this.renderAttribution(), hasSize && this.renderWarning());
    }
  }]);
