  ...
  _createClass(Map, [
    ...
    },
    {
      ...
      value: function() {
        ...
        var childrenChecked = this.props.children
          ? Array.isArray && Array.isArray(this.props.children)
            ? this.props.children
            : [].concat(this.props.children)
          : [];

        childrenWithProps = childrenChecked
          .filter(function(c) {
            return c;
          })
          .map(function(child) {
        ...
        return createVNode(2, "div", null, childrenWithProps, {
          style: {
            position: "absolute",
            width: width,
            height: height,
        ...
        return createVNode(
          ...
          [
            ...
            attribution ||
              createVNode(2, "span", null, [
                " © ",
                createVNode(2, "a", null, "OpenStreetMap", {
