    ...
    return (
        ...
        {props.searched == false ? 
            ...
            >
             <h2 
                style={{ padding:' 10px' }} 
                className="text-grey-darkest sm:text-xl text-xxl uppercase">Track your Seed</h2>
            ...
            <hr style={{ backgroundColor: 'rgba(103, 112, 117, 0.2)', height: '2px'}} />
                ...
                <div className="w-full pb-4">
                    <div className="p-2">
                        <h3 className="text-grey-darkest sm:text-sm p-2 uppercase">Please, select one option:</h3>
                    </div>
                    ...
                    <div className="p-2">
                        <h3 className="text-grey-darkest sm:text-sm p-2 uppercase">Insert here your email to receive a copy:</h3>
                    </div>
                    ...
                    <div className="p-2">
                        <h3 className="text-grey-darkest sm:text-sm p-2 uppercase">Tracking number:</h3>
                    </div>
                    ...
                    <div className="inline-flex sm:w-full sm:mt-2 md:w-full md:mt-2">
                        <button style={{transition: 'all 0.5s ease'}} className="h-10 bg-grey-darkest text-white text-md border border-light-blue uppercase px-5 ml-1 font-bold hover:bg-grey-light hover:text-grey-darkest hover:border-transparent hover:border sm:w-full md:w-full" 
                        onClick={()=> {
