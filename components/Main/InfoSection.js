...
const InfoSection = props => {
  ...
  return (
    ...
    //     right: "0",
    // }}
    // className="absolute w-400 pin-b md:pin-l lg:pin-l xl:pin-l xxl:pin-l mb-12 ml-2 sm:mx-0 z-50 p-2 sm:w-7/8 sm:h-250 sm:text-sm bg-white z-50 p-2">
    <div
      id="infoSection"
      style={{
        borderRadius: "2%"
      }}
      className="absolute w-400 min-h-card h-550 pin-b pin-l mb-12 ml-2 sm:mx-0 z-50 p-2 sm:w-7/8 sm:min-h-mobileCard sm:h-380 sm:text-sm bg-white z-50 p-2"
    >
      ...
      <div className="px-2">
        ...
        {props.currentInformation == 0 ? (
          <div className="pb-1 pt-1">
            ...
            <hr
              style={{
                backgroundColor: "rgba(21, 21, 21, 0.31)",
                height: "2px"
              }}
            />
...
//                 <div className="inline-flex p-2 text-center">Company</div>
//                 <div className="inline-flex p-2 text-center">Detail</div>
//                 <div className="inline-flex p-2 text-center">Test</div>
//                 <div className="inline-flex p-2 text-center">Facts</div>
//             </div>
//             <hr
//                 style={{ backgroundColor: "rgba(21, 21, 21, 0.31)", height: "2px" }}
//             /> 
