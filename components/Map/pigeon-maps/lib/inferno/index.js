...
var Map = function (_Component) {
  ...
  _createClass(Map, [{
    ...
    value: function () {
      ...
      return createVNode(2, 'div', boxClassname, createVNode(2, 'div', null, tiles.map(function (tile) {
        return createVNode(2, 'img', null, null, {
          'src': tile.url,
          'width': tile.width,
          'height': tile.height,
          'onLoad': function () {
    ...
    value: function () {
      ...
      childrenWithProps = childrenChecked.filter(function (c) {
        return c;
      }).map(function (child) {
    ...
    value: function () {
      ...
      return createVNode(2, 'div', 'pigeon-attribution', [attributionPrefix === false ? null : createVNode(2, 'span', null, [attributionPrefix || createVNode(2, 'a', null, 'Pigeon', {
        'href': 'https://pigeon-maps.js.org/',
        'style': linkStyle
      }), ' | ']), attribution || createVNode(2, 'span', null, [' © ', createVNode(2, 'a', null, 'OpenStreetMap', {
    ...
    value: function () {
      ...
      if (metaWheelZoom && metaWheelZoomWarning || twoFingerDrag && twoFingerDragWarning) {
        ...
        return createVNode(2, 'div', null, warningText.replace('META', meta), {
          'style': style
        });
      } else {
        return null;
    ...
    value: function () {
      ...
      return createVNode(2, 'div', null, [hasSize && this.renderTiles(), hasSize && this.renderOverlays(), hasSize && this.renderAttribution(), hasSize && this.renderWarning()], {
